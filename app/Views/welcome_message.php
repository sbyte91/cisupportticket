...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            <?php $a = (auth()->user()->username) ?? null ?>
            <h4><?= !empty($a) ? 'You are currently logged in <i>'.$a.'</i>' : null ?></h4>


            <div class="row" style="text-align: center;">
                <div class="col-md-3">
                    <img src="<?= base_url() ?>/public/dist/img/features-3.svg" width="400px" class="img-fluid" alt="">
                </div>
                <div class="col-md-3">
                <h2>Support Ticket System</h2></p>
            </div>
            </div>
